...
- This is hello-react-front-end application <a href="https://github.com/akezeth/hello-react-front-end">Front-end Link</a>
...
```bash
  git clone https://github.com/akezeth/hello-rails-back-end.git
```
